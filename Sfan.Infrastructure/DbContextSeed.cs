...
namespace Sfan.Infrastructure
{
    public class DbContextSeed
    {
        ...
        {
            var user = new ApplicationUser { Email = "sfan@shengshi.com", UserName = "admin" };
            await userManager.CreateAsync(user, "shengshi");
            var createdUser = await userManager.FindByEmailAsync("sfan@shengshi.com");
            return createdUser;
        }
        /// <summary>
        /// 为用户添加权限
